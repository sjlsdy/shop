...
module.exports = {
    ...
    IndexUrlTopBanner: API_BASE_URL + 'ad/list', //专题精选轮播图
    ...
    AuthLoginBindMobile: API_BASE_URL + 'user/getBindMobile', //获取手机号
    ...
    QueryLogistics: API_BASE_URL + 'express/get_express_info',  //查询物流信息
